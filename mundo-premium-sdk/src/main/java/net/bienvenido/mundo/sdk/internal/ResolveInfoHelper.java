...
public final class ResolveInfoHelper {
    ...
    public static final ResolveInfoHelper f166 = new ResolveInfoHelper();
            ...
            if (AppVirtualEnv.f100) {
                packageInfo = (PackageInfo) MundoPackageManagerServiceProxy.INSTANCE.m156(new Function1() {
                    public final Object invoke(Object obj) {
                        return ResolveInfoHelper.m168(str, (IMundoPackageManagerService) obj);
                    }
                });
            } else {
                ...
                packageInfo = (PackageInfo) MundoGlobalContext.m576(new Function1() {
                    public final Object invoke(Object obj) {
                        return ResolveInfoHelper.m169(str, (PackageManager) obj);
                    }
                });
            }
