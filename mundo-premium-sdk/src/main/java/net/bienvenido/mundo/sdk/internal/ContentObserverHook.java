...
public final class ContentObserverHook extends DefaultParamHandler {
            ...
            if (sConditionCheckField.sSpecificMethodField) {
                    ...
                    for (final Uri uri : uriArr) {
                        MundoContentServiceProxy.INSTANCE.m156(new Function1() {
                            ...
                            public final Object invoke(Object obj2) {
                                return ContentObserverHook.m46(this.f$0, this.f$1, this.f$2, (IMundoContentProviderService) obj2);
                            }
                        });
                    }
                }
                ...
                if (uri2 != null) {
                    MundoContentServiceProxy.INSTANCE.m156(new Function1() {
                        ...
                        public final Object invoke(Object obj2) {
                            return ContentObserverHook.m45(this.f$0, this.f$1, this.f$2, (IMundoContentProviderService) obj2);
                        }
                    });
                }
            }
