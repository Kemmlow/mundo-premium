...
public final class SdkSystemUtils implements IMundoAccountManagerService {


    public final IBinder f376;

    public SdkSystemUtils(IBinder iBinder) {
        this.f376 = iBinder;
    }
    ...
    public final HashMap getAuthTokenLabel(String str, String str2) {
        ...
        try {
            try {
                ...
                parcelObtain2.readException();
                HashMap readHashMap = parcelObtain2.readHashMap(SdkSystemUtils.class.getClassLoader());
                parcelObtain2.recycle();
                parcelObtain.recycle();
                return readHashMap;
            } catch (RemoteException e) {
