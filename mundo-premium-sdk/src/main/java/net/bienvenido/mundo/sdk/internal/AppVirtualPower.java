...
public final class AppVirtualPower extends MutablePropertyReference1Impl {


    public static final AppVirtualPower f159 = new AppVirtualPower();

    public AppVirtualPower() {
