...
public final class ActivityRecord implements IBinder.DeathRecipient {
    ...
    public ActivityRecord(IBinder iBinder, WindowManagerHookImpl o5Var) {
        this.f286 = iBinder;
        this.f287 = o5Var;
    }


    public static final void m417(IBinder iBinder, ActivityRecord p5Var, WindowManagerHookImpl o5Var) {
        try {
    ...
    public final void binderDied() {
        ...
        sActivityManagerMethod.InvocationHandlerWrapper.execute(new Runnable() {
            ...
            public final ActivityRecord f$1;
            public final WindowManagerHookImpl f$2;

            {
                this.f$0 = iBinder;
                this.f$1 = ActivityRecord.this;
                this.f$2 = o5Var;
            }

            @Override // java.lang.Runnable
            public final void run() {
                ActivityRecord.m417(this.f$0, this.f$1, this.f$2);
            }
        });
    }
}
