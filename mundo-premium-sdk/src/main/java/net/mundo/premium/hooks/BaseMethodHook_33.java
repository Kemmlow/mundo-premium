...
public final class BaseMethodHook_33 extends IActivityManagerInterface {
    ...
    public static final BaseMethodHook_33 f359 = new BaseMethodHook_33();
            ...
            if (!CollectionUtils.m360(intent.getFlags(), 1073741824)) {
                ...
                List list2 = (List) MundoGlobalContext.m576(new Function1() {
                    ...
                    public final Object invoke(Object obj) {
                        return BaseMethodHook_33.m509(this.f$0, (PackageManager) obj);
                    }
                });
                if (list2 != null) {
                    list.addAll(list2);
        ...
        try {
            ...
            sActivityManagerMethod.InvocationHandlerWrapper.execute(new Runnable() {
                ...
                public final void run() {
                    BaseMethodHook_33.m503(this.f$0, this.f$1, this.f$2);
                }
            });
    ...
    public final boolean unbindService(final IBinder iBinder) {
        try {
            ...
            sActivityManagerMethod.InvocationHandlerWrapper.execute(new Runnable() {
                ...
                @Override // java.lang.Runnable
                public final void run() {
                    BaseMethodHook_33.m500(this.f$0, this.f$1);
                }
            });
            return true;
        } catch (Exception e) {
    ...
    public final int startActivityAsUser(Intent intent, String str) {
        ...
        try {
            ...
            sActivityManagerMethod.InvocationHandlerWrapper.execute(new Runnable() {
                ...
                @Override // java.lang.Runnable
                public final void run() {
                    BaseMethodHook_33.m501(this.f$0, this.f$1, this.f$2);
                }
            });
            return 1;
        } catch (Exception e) {
        ...
        try {
            ...
            if (!concurrentHashMap.containsKey(iBinder)) {
                ...
                if (i > 500) {
                    ...
                    sActivityManagerMethod.InvocationHandlerWrapper.execute(new Runnable() {
                        ...
                        @Override // java.lang.Runnable
                        public final void run() {
                            BaseMethodHook_33.m499(this.f$0, this.f$1, this.f$2);
                        }
                    });
                }
            }
            ...
            if (pair != null && ((Intent) pair.getFirst()).filterEquals(intent)) {
                ...
                sActivityManagerMethod.InvocationHandlerWrapper.execute(new Runnable() {
                    ...
                    @Override // java.lang.Runnable
                    public final void run() {
                        BaseMethodHook_33.m506(this.f$0, this.f$1, this.f$2);
                    }
                });
                return 1;
            }
            ...
            sActivityManagerMethod.InvocationHandlerWrapper.execute(new Runnable() {
                ...
                @Override // java.lang.Runnable
                public final void run() {
                    BaseMethodHook_33.m496(this.f$0, this.f$1, this.f$2, this.f$3);
                }
            });
            return 1;
        } catch (Exception e) {
            ...
            if (providerInfo == null) {
                ...
                ProviderInfo providerInfo3 = (ProviderInfo) MundoGlobalContext.m576(new Function1() {
                    ...
                    public final Object invoke(Object obj2) {
                        return BaseMethodHook_33.m504(this.f$0, (PackageManager) obj2);
                    }
                });
    ...
    public static ServiceInfo m505(final Intent intent) {
        ...
        ResolveInfo resolveInfo2 = (ResolveInfo) MundoGlobalContext.m576(new Function1() {
            ...
            public final Object invoke(Object obj) {
                return BaseMethodHook_33.m498(this.f$0, (PackageManager) obj);
            }
        });
    ...
    public final boolean unregisterReceiver(ComponentName componentName, final IBinder iBinder, int i) {
        try {
            ...
            sActivityManagerMethod.InvocationHandlerWrapper.execute(new Runnable() {
                ...
                @Override // java.lang.Runnable
                public final void run() {
                    BaseMethodHook_33.m4975(this.f$0);
                }
            });
            return true;
        } catch (Exception e) {
    ...
    public final boolean registerServiceConnection(final IBinder iBinder, final Intent intent, final IBinder iBinder2) {
        ...
        try {
            ...
            sActivityManagerMethod.InvocationHandlerWrapper.execute(new Runnable() {
                ...
                @Override // java.lang.Runnable
                public final void run() {
                    BaseMethodHook_33.m507(this.f$0, this.f$1, this.f$2, this.f$3);
                }
            });
            return true;
        } catch (Throwable th) {
        ...
        try {
            ...
            if (serviceInfo == null) {
                ...
                ServiceInfo serviceInfo3 = (ServiceInfo) MundoGlobalContext.m576(new Function1() {
                    ...
                    public final Object invoke(Object obj) {
                        return BaseMethodHook_33.m508(this.f$0, (PackageManager) obj);
                    }
                });
