...
public final class AppConfig extends DefaultParamHandler {


    public static final AppConfig f402 = new AppConfig();
                ...
                for (int i = 0; i < length; i++) {
                    ...
                    Intent intent2 = (iIntValue == 1 || iIntValue == 2 || iIntValue == 4 || iIntValue == 5) ? (Intent) MundoWindowManagerServiceProxy.INSTANCE.m156(new Function1() {
                        ...
                        public final Object invoke(Object obj2) {
                            return AppConfig.m528(this.f$0, this.f$1, (IMundoWindowManagerService) obj2);
                        }
                    }) : null;
