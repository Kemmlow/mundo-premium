...
public final class MundoHookCore extends FunctionReferenceImpl implements Function1 {

    
    public static final MundoHookCore INSTANCE = new MundoHookCore();

    public MundoHookCore() {
