...
public final class MundoAppTombstones extends FunctionReferenceImpl implements Function1 {


    public static final MundoAppTombstones f225 = new MundoAppTombstones();

    public MundoAppTombstones() {
