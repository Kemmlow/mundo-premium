...
public final class MundoServiceProxy_1 extends DefaultParamHandler {


    public static final MundoServiceProxy_1 f442 = new MundoServiceProxy_1();
                ...
                if (i >= 0) {
                    ...
                    Intent intent2 = (Intent) MundoWindowManagerServiceProxy.INSTANCE.m156(new Function1() {
                        ...
                        public final Object invoke(Object obj2) {
                            return MundoServiceProxy_1.m578(this.f$0, this.f$1, this.f$2, (IMundoWindowManagerService) obj2);
                        }
                    });
                    if (intent2 != null) {
                        objArr[i] = intent2;
