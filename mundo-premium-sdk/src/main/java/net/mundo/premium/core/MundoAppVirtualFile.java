...
public final class MundoAppVirtualFile extends FunctionReferenceImpl implements Function4 {

    
    public static final MundoAppVirtualFile f157 = new MundoAppVirtualFile();

    public MundoAppVirtualFile() {
