...
public final class ActivityManagerHook_2 extends AbstractMundoServiceBinder {


    public static final ActivityManagerHook_2 f213 = new ActivityManagerHook_2();
    ...
    public static void m22x541a43c1() {
        ...
        sActivityManagerMethod.InvocationHandlerWrapper.execute(new Runnable() {
            @Override // java.lang.Runnable
            public final void run() {
                ActivityManagerHook_2.m21x4f52efc();
            }
        });
    }
