...
import top.bienvenido.mundo.external.ProcessCallbackWrapper;
import top.bienvenido.mundo.common.initialize.MNative;

public final class MundoServiceProxy_10 extends AbstractMundoBinder {
    ...
    public static final MundoServiceProxy_10 f89 = new MundoServiceProxy_10();
    ...
    static {
        ...
        callback = new Function0() {
            public final Object invoke() {
                try {
                    return MundoServiceProxy_10.getApplication();
        ...
        callback = new Function0() {
            public final Object invoke() {
                try {
                    return MundoServiceProxy_10.createLoadedApk();
                } catch (Exception AppVirtualUsb) {
                    return null;
                }
            }
    ...
    public static final LoadedApk createLoadedApk() throws PackageManager.NameNotFoundException {
        ...
        callback = new Function0() {
            ...
            public final Object invoke() {
                return MundoServiceProxy_10.cleanupLoadedApk(this.f$0);
            }
        };
        ...
        try {
            ...
            MundoActivityManagerServiceProxy.INSTANCE.m156(new Function1() {
                ...
                public final Object invoke(Object obj) {
                    return Boolean.valueOf(MundoServiceProxy_10.m78(this.f$0, this.f$1, this.f$2, (IMundoActivityManagerService) obj));
                }
            });
        } catch (Exception e) {
        }
            ...
            if (sConditionCheckField.sProcessObserverMethod) {
                ...
                Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
                    ...
                    public final void uncaughtException(Thread thread, Throwable th) {
                        try {
                            MundoServiceProxy_10.m71(this.f$0, thread, th);
                        } catch (Throwable t) {
                            t.printStackTrace();
                        }
                    }
    ...
    public static final Unit getApplication() {
        callback = new Function0() {
            public final Object invoke() {
                try {
                    return MundoServiceProxy_10.noop();
                } catch (Exception e) {
                    return null;
                }
            }
        ...
        try {
            ...
            Runnable runnable = new Runnable() {
                ...
                public final void run() {
                    MundoServiceProxy_10.m1x541a43c1();
                }
            };
            ...
            final Future[] futureArr = {executorService2.submit(runnable), executorService2.submit(new Runnable() {
                @Override // java.lang.Runnable
                public final void run() {
                    MundoServiceProxy_10.m0x4f52efc();
                }
            }), executorService2.submit(new Runnable() {
                @Override // java.lang.Runnable
                public final void run() {
                    MundoServiceProxy_10.installSystemProviders();
                }
            }), executorService2.submit(new Runnable() {
                @Override // java.lang.Runnable
                public final void run() {
                    MundoServiceProxy_10.scheduleFinalCleanupForProvider();
                }
            }), executorService2.submit(new Runnable() {
                @Override // java.lang.Runnable
                public final void run() {
                    MundoServiceProxy_10.onServiceBind();
                }
            })};
            f76.post(new Runnable() {
                ...
                @Override // java.lang.Runnable
                public final void run() {
                    MundoServiceProxy_10.m72(this.f$0);
                }
            });
        } catch (Exception e) {
        }
    ...
    public final void cancelNotification(final IBinder iBinder) {
        f76.post(new Runnable() {
            ...
            @Override // java.lang.Runnable
            public final void run() {
                MundoServiceProxy_10.m705(this.f$0);
            }
        });
    }
        ...
        try {
            ...
            if (AppVirtualEnv.f100) {
                packageInfo = (PackageInfo) MundoPackageManagerServiceProxy.INSTANCE.m156(new Function1() {
                    ...
                    public final Object invoke(Object obj) {
                        return MundoServiceProxy_10.m73(this.f$0, (IMundoPackageManagerService) obj);
                    }
                });
            } else {
                ...
                packageInfo = (PackageInfo) MundoGlobalContext.m576(new Function1() {
                    ...
                    public final Object invoke(Object obj) {
                        return MundoServiceProxy_10.m74(this.f$0, (PackageManager) obj);
                    }
                });
            }
            if (packageInfo != null) {
            ...
            if (!sConditionCheckField.InvocationHandlerWrapper && (str = (String) MundoPackageManagerServiceProxy.INSTANCE.m156(new Function1() {
                ...
                public final Object invoke(Object obj2) {
                    return MundoServiceProxy_10.m59(this.f$0, (IMundoPackageManagerService) obj2);
                }
            })) != null && str.length() != 0) {
    ...
    public final void mo63(final String str, final Intent intent, final IBinder iBinder, final int i) {
        ...
        f76.post(new Runnable() {
            ...
            @Override // java.lang.Runnable
            public final void run() {
                MundoServiceProxy_10.m68(this.f$0, this.f$1, this.f$2, this.f$3);
            }
        });
    }
    ...
    public final void m645() {
        try {
            ...
            Future<?> futureSubmit = sActivityManagerMethod.InvocationHandlerWrapper.submit(new Runnable() {
                public final MundoServiceProxy_10 f$0;

                {
                    this.f$0 = MundoServiceProxy_10.this;
                }
            ...
            sActivityManagerMethod.InvocationHandlerWrapper.execute(new Runnable() {
                @Override // java.lang.Runnable
                public final void run() {
                    MundoServiceProxy_10.triggerProcessCallback();
                }
            });
        } catch (Exception e) {
    ...
    public final void mo65(final IBinder iBinder, final Intent intent) {
        f76.post(new Runnable() {
            ...
            @Override // java.lang.Runnable
            public final void run() {
                MundoServiceProxy_10.onServiceUnbind(this.f$0, this.f$1);
            }
        });
    }
    ...
    public final void mo77(final IBinder iBinder, final Intent intent) {
        f76.post(new Runnable() {
            ...
            @Override // java.lang.Runnable
            public final void run() {
                MundoServiceProxy_10.onServiceUnbindAsync(this.f$0, this.f$1);
            }
        });
    }
    ...
    public static void m79(final IBinder iBinder, final Intent intent, final int i) {
        f76.post(new Runnable() {
            ...
            @Override // java.lang.Runnable
            public final void run() {
                MundoServiceProxy_10.installContentProviders(this.f$0, this.f$1, this.f$2);
            }
        });
    }
