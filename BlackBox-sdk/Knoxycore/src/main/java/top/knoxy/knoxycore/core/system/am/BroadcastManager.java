...
import dev.knoxy.core.core.system.pm.BPackage;
...
import dev.knoxy.core.proxy.ProxyBroadcastReceiver;
import dev.knoxy.core.utils.Slog;

/**
 * Created by KnoxyCore on 2022/2/28.
 */
        ...
        synchronized (mReceivers) {
            ...
            for (BPackage.Activity receiver : bPackage.receivers) {
                ...
                for (BPackage.ActivityIntentInfo intent : intents) {
                    ...
                    KnoxyCoreCore.getContext().registerReceiver(proxyBroadcastReceiver, intent.intentFilter);
            ...
            synchronized (mReceivers) {
                ...
                if (broadcastReceivers != null) {
                    ...
                    for (BroadcastReceiver broadcastReceiver : broadcastReceivers) {
                        try {
                            KnoxyCoreCore.getContext().unregisterReceiver(broadcastReceiver);
