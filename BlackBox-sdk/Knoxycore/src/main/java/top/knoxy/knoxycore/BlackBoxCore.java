...
import dev.knoxy.core.app.LauncherActivity;
import dev.knoxy.core.app.configuration.AppLifecycleCallback;
import dev.knoxy.core.app.configuration.ClientConfiguration;
import dev.knoxy.core.core.GmsCore;
import dev.knoxy.core.core.env.BEnvironment;
import dev.knoxy.core.core.system.DaemonService;
import dev.knoxy.core.core.system.ServiceManager;
import dev.knoxy.core.core.system.user.BUserHandle;
import dev.knoxy.core.core.system.user.BUserInfo;
import dev.knoxy.core.entity.pm.InstallOption;
import dev.knoxy.core.entity.pm.InstallResult;
...
import dev.knoxy.core.fake.frameworks.BJobManager;
import dev.knoxy.core.fake.frameworks.BPackageManager;
import dev.knoxy.core.fake.frameworks.BStorageManager;
import dev.knoxy.core.fake.frameworks.BUserManager;
...
import dev.knoxy.core.utils.ShellUtils;
import dev.knoxy.core.utils.Slog;
import dev.knoxy.core.utils.compat.BuildCompat;
import dev.knoxy.core.utils.compat.BundleCompat;
import dev.knoxy.core.utils.compat.XposedParserCompat;
import dev.knoxy.core.utils.provider.ProviderCall;
...
public class KnoxyCoreCore extends ClientConfiguration {
    public static final String TAG = "KnoxyCoreCore";

    private static final KnoxyCoreCore sKnoxyCoreCore = new KnoxyCoreCore();
    ...
    public static KnoxyCoreCore get() {
        return sKnoxyCoreCore;
    }
    ...
    public void doAttachBaseContext(Context context, ClientConfiguration clientConfiguration) {
        ...
        if (processName.equals(KnoxyCoreCore.getHostPkg())) {
        ...
        if (KnoxyCoreCore.get().isBlackProcess()) {
            BEnvironment.load();
...
//            android.os.Debug.waitForDebugger();
    ...
    private void initNotificationManager() {
        NotificationManager nm = (NotificationManager) KnoxyCoreCore.getContext().getSystemService(Context.NOTIFICATION_SERVICE);
        String CHANNEL_ONE_ID = KnoxyCoreCore.getContext().getPackageName() + ".knoxycore_core";
        String CHANNEL_ONE_NAME = "knoxycore_core";
        if (BuildCompat.isOreo()) {
