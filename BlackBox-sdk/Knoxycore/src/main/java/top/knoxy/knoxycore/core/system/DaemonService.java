...
public class DaemonService extends Service {
    ...
    private static final int NOTIFY_ID = KnoxyCoreCore.getHostPkg().hashCode();
    ...
    private void showNotification() {
        NotificationCompat.Builder builder = new NotificationCompat.Builder(getApplicationContext(), getPackageName() + ".knoxycore_core")
