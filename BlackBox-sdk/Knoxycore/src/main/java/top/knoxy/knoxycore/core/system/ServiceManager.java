...
public class ServiceManager {
    ...
    public static void initBlackManager() {
        KnoxyCoreCore.get().getService(ACTIVITY_MANAGER);
        KnoxyCoreCore.get().getService(JOB_MANAGER);
        KnoxyCoreCore.get().getService(PACKAGE_MANAGER);
        KnoxyCoreCore.get().getService(STORAGE_MANAGER);
        KnoxyCoreCore.get().getService(USER_MANAGER);
        KnoxyCoreCore.get().getService(XPOSED_MANAGER);
        KnoxyCoreCore.get().getService(ACCOUNT_MANAGER);
        KnoxyCoreCore.get().getService(LOCATION_MANAGER);
        KnoxyCoreCore.get().getService(NOTIFICATION_MANAGER);
    }
}
