package dev.knoxy.core.utils.provider;
...
import dev.knoxy.core.utils.compat.ContentProviderCompat;
...
public class ProviderCall {
    public static Bundle callSafely(String authority, String methodName, String arg, Bundle bundle) {
        try {
            return call(authority, KnoxyCoreCore.getContext(), methodName, arg, bundle, 5);
