package dev.knoxy.core.core.env;
...
public class BEnvironment {
    private static final File sVirtualRoot = new File(KnoxyCoreCore.getContext().getCacheDir().getParent(), "knoxycore");
    private static final File sExternalVirtualRoot = KnoxyCoreCore.getContext().getExternalFilesDir("knoxycore");
