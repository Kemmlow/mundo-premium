...
import dev.knoxy.core.utils.HackAppUtils;
import dev.knoxy.core.utils.compat.ActivityCompat;
...
public final class AppInstrumentation extends BaseInstrumentationDelegate implements IInjectHook {
    ...
    public void injectHook() {
        try {
            ...
            BRActivityThread.get(KnoxyCoreCore.mainThread())._set_mInstrumentation(this);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
