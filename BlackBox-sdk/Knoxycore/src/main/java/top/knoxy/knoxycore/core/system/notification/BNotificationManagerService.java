package dev.knoxy.core.core.system.notification;
...
/**
 * Created by KnoxyCore on 2022/3/15.
 */
public class BNotificationManagerService extends IBNotificationManagerService.Stub implements ISystemService {
    ...
    private final NotificationManager mRealNotificationManager =
            (NotificationManager) KnoxyCoreCore.getContext().getSystemService(Context.NOTIFICATION_SERVICE);
