package dev.knoxy.core.fake.service.context.providers;
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        if (args != null && args.length > 0) {
            ...
            if (arg instanceof String) {
                args[0] = KnoxyCoreCore.getHostPkg();
            } else if (arg.getClass().getName().equals(BRAttributionSource.getRealClass().getName())) {
                ContextCompat.fixAttributionSourceState(arg, KnoxyCoreCore.getHostUid());
            }
        }
        return method.invoke(mBase, args);
    }
