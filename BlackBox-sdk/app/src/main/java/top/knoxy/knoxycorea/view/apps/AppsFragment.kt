package dev.knoxy.corea.view.apps
...
import dev.knoxy.corea.databinding.FragmentAppsBinding
import dev.knoxy.corea.util.InjectionUtil
import dev.knoxy.corea.util.ShortcutUtil
import dev.knoxy.corea.util.inflate
import dev.knoxy.corea.util.toast
import dev.knoxy.corea.view.base.LoadingActivity
import dev.knoxy.corea.view.main.MainActivity
import java.util.*
...
class AppsFragment : Fragment() {
    ...
    private fun stopApk(info: AppInfo) {
        MaterialDialog(requireContext()).show {
            ...
            positiveButton(R.string.done) {
                KnoxyCoreCore.get().stopPackage(info.packageName, userID)
