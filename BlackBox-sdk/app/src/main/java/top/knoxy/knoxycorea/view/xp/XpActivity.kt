...
import dev.knoxy.corea.bean.XpModuleInfo
import dev.knoxy.corea.databinding.ActivityXpBinding
        ...
        private fun initRecyclerView() {
            ...
            mAdapter = RVAdapter<XpModuleInfo>(this, XpAdapter()).bind(viewBinding.recyclerView)
                .setItemClickListener { view, item, position ->
                    ...
                    KnoxyCoreCore.get().setModuleEnable(item.packageName, item.enable)
