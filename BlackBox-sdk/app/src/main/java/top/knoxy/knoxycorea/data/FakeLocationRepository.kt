...
class FakeLocationRepository {
    ...
    fun getInstalledAppList(
        ...
        val installedApplications: List<ApplicationInfo> =
            KnoxyCoreCore.get().getInstalledApplications(0, userID)
...
//            val isXpModule = KnoxyCoreCore.get().isXposedModule(file)
            ...
            val info = FakeLocationBean(
                userID,
                installedApplication.loadLabel(KnoxyCoreCore.getPackageManager()).toString(),
                installedApplication.loadIcon(KnoxyCoreCore.getPackageManager()),
