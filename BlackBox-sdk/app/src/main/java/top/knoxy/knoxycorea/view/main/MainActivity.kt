...
import dev.knoxy.corea.databinding.ActivityMainBinding
import dev.knoxy.corea.util.Resolution
import dev.knoxy.corea.util.inflate
import dev.knoxy.corea.view.apps.AppsFragment
import dev.knoxy.corea.view.base.LoadingActivity
import dev.knoxy.corea.view.fake.FakeManagerActivity
import dev.knoxy.corea.view.list.ListActivity
import dev.knoxy.corea.view.setting.SettingActivity
...
class MainActivity : LoadingActivity() {
    ...
    private fun initViewPager() {
        ...
        val userList = KnoxyCoreCore.get().users
        userList.forEach {
    ...
    override fun onOptionsItemSelected(item: MenuItem?): Boolean {
        when (item?.itemId) {
            R.id.main_git -> {
                val intent =
                    Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/FKnoxyCore/KnoxyCore"))
            ...
            R.id.main_tg -> {
                val intent =
                    Intent(Intent.ACTION_VIEW, Uri.parse("https://t.me/fvknoxycore"))
                startActivity(intent)
            }
