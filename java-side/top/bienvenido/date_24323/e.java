...
public final class e {
   public static final ArrayList 我要送你妈一朵花哈哈哈开玩笑的我哪来的花你哪来的妈;
   public static final String 狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰;
   public static final String 要不要把你妈卵子扣出来给你做寿司吃;
   ...
   static {
      ...
      狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰 = sb.toString();
      SecureRandom secureRandom2 = new SecureRandom();
      StringBuilder sb2 = new StringBuilder(
         new String[]{"35133133", "86576905", "86811305", "86538206", "35619596", "86415006", "86953506", "86866106"}[secureRandom2.nextInt(8)]
      );
      ...
      要不要把你妈卵子扣出来给你做寿司吃 = sb2.toString();
      ...
      if (父母们悬挂树木从尸体中养猪让灵车漂浮跳过坟墓螺旋爆炸砂纸打磨棺材冲浪火烧用尸体泡茶将米与骨灰混合在祖坟前唱歌以及埋葬聚会葬礼庆典骨髓汤浇脑花棺材开花.要不要把你妈卵子扣出来给你做寿司吃) {
         ...
         try {
            ...
            subscriptionInfo = (SubscriptionInfo)allocMethod.invoke(t9.狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰, SubscriptionInfo.class);
         } catch (Exception var21) {
         }

         try {
            Pair pair = TuplesKt.to("mDisplayName", "blackeji.62v.net");
            String str = 狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰;
            ...
            for (int i6 = 0; i6 < 5; i6++) {
               ...
               (new n2((String)pair6.getFirst()))
                  .要不要把你妈卵子扣出来给你做寿司吃
                  .____________________________________________/* $VF was: 狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰 */(subscriptionInfo, pair6.getSecond());
            }
      ...
      我要送你妈一朵花哈哈哈开玩笑的我哪来的花你哪来的妈 = arrayListArrayListOf;
   }
}
