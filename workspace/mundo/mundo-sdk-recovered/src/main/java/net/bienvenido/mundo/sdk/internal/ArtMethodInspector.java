...
import net.bienvenido.mundo.sdk.common.reflection.MundoReflectionStub$Class;
import net.bienvenido.mundo.sdk.common.reflection.MundoReflectionStub$Executable;
import net.bienvenido.mundo.sdk.common.reflection.MundoReflectionStub$InvokeStub;
import net.bienvenido.mundo.sdk.common.reflection.MundoReflectionStub$MethodHandle;
import net.bienvenido.mundo.sdk.common.reflection.MundoReflectionStub$NeverCall;

public final class ArtMethodInspector {
    ...
    public ArtMethodInspector(Class cls) throws NoSuchMethodException {
