...
public final class ContentProviderRecord extends 我是月黑风高偷你妈棺材钱的爹 {

    
    public static final ContentProviderRecord f134 = new ContentProviderRecord();
        ...
        if (i9Var.m246(service.getClassName().hashCode())) {
            MundoActivityManagerServiceProxy.INSTANCE.m156(new Function1() {
                ...
                public final Object invoke(Object obj) {
                    return Integer.valueOf(ContentProviderRecord.m138(this.f$0, (IMundoActivityManagerService) obj));
                }
            });
            if (i9Var.f196 > 128) {
                i9Var.f196 = 0;
