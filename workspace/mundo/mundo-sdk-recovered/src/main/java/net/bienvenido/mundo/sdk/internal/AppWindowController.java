...
public final class AppWindowController extends AppVirtualMemory {
    ...
    public AppWindowController(PackageInfo packageInfo, ApplicationInfo applicationInfo) {
    ...
    public AppWindowController(PackageInfo packageInfo, ApplicationInfo applicationInfo, TypeArrayBuilder h9Var) {
