...
public final class AppVirtualBootloader extends 我是月黑风高偷你妈棺材钱的爹 {

    
    public static final AppVirtualBootloader f194 = new AppVirtualBootloader();

    
    public static final void m243(AppVirtualBootloader i8Var, Object[] objArr) {
        i8Var.getClass();
        Object obj = objArr[1];
        try {
