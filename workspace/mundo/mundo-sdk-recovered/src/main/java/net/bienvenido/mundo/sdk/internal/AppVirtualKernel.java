...
public final class AppVirtualKernel extends MutablePropertyReference1Impl {

    
    public static final AppVirtualKernel f190 = new AppVirtualKernel();

    public AppVirtualKernel() {
