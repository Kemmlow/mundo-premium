...
import net.bienvenido.mundo.sdk.manifest.MundoIntermediary;
import net.bienvenido.mundo.sdk.manifest.MundoService$Companion$STUB;

public final class WindowManagerServiceImpl extends IWindowManagerInterface {
    ...
    public static final WindowManagerServiceImpl f178 = new WindowManagerServiceImpl();
    ...
    static {
        ...
        if (z) {
            function1 = new Function1() {
                public final Object invoke(Object obj) {
                    return WindowManagerServiceImpl.m172((IBinder) obj);
                }
            };
        } else if (sConditionCheckField.sMethodRefField) {
            function1 = new Function1() {
                public final Object invoke(Object obj) {
                    return WindowManagerServiceImpl.m174((IBinder) obj);
                }
            };
        } else {
            function1 = sConditionCheckField.sServiceNameField ? new Function1() {
                public final Object invoke(Object obj) {
                    return WindowManagerServiceImpl.m184dj((IBinder) obj);
                }
            } : new Function1() {
                public final Object invoke(Object obj) {
                    return WindowManagerServiceImpl.m7x541a43c1((IBinder) obj);
                }
            };
        }
        f172 = function1;
        f21xb7bf1d91 = new Function0() {
            public final Object invoke() {
                return WindowManagerServiceImpl.m1835();
            }
        };
        f177 = new Function0() {
            public final Object invoke() {
                return WindowManagerServiceImpl.m9x541a43c1();
            }
        };
        f1765 = new Function0() {
            public final Object invoke() {
                return WindowManagerServiceImpl.m188();
            }
        };
        if (z) {
            function12 = new Function1() {
                public final Object invoke(Object obj) {
                    return Integer.valueOf(WindowManagerServiceImpl.m6x4f52efc((IBinder) obj));
                }
            };
        } else {
            function12 = sConditionCheckField.sMethodRefField ? new Function1() {
                public final Object invoke(Object obj) {
                    return Integer.valueOf(WindowManagerServiceImpl.m177((IBinder) obj));
                }
            } : new Function1() {
                public final Object invoke(Object obj) {
                    return Integer.valueOf(WindowManagerServiceImpl.m175((IBinder) obj));
                }
            };
        }
        f173 = function12;
        f175 = new Function0() {
            public final Object invoke() {
                return WindowManagerServiceImpl.m173dj();
            }
        };
    ...
    public static final WindowContainerToken m173dj() {
        try {
            ...
            f175 = new Function0() {
                ...
                public final Object invoke() {
                    return WindowManagerServiceImpl.m216(this.f$0);
                }
            };
            return null;
        } catch (Throwable th) {
    ...
    public static final Object m1835() {
        ...
        f21xb7bf1d91 = new Function0() {
            ...
            public final Object invoke() {
                return WindowManagerServiceImpl.m210(this.f$0);
            }
        };
        return serializable;
    }
    ...
    public static final Class m188() {
        ...
        if (cls != null) {
            f1765 = new Function0() {
                ...
                public final Object invoke() {
                    return WindowManagerServiceImpl.m211(this.f$0);
                }
            };
            return cls;
        }
    ...
    public static final Object m9x541a43c1() {
        ...
        if (serializable != null) {
            f177 = new Function0() {
                ...
                public final Object invoke() {
                    return WindowManagerServiceImpl.m193(this.f$0);
                }
            };
            return serializable;
        }
    ...
    public final void onActivityDestroyed(final IBinder iBinder) {
        ...
        sActivityManagerMethod.ProcessCallbackWrapper.execute(new Runnable() {
            ...
            @Override // java.lang.Runnable
            public final void run() {
                WindowManagerServiceImpl.m1855(this.f$0);
            }
        });
    }
    ...
    public final boolean isAppSplashConfigured(final String str, final String str2) {
        ...
        try {
            ...
            sActivityManagerMethod.ProcessCallbackWrapper.execute(new Runnable() {
                ...
                @Override // java.lang.Runnable
                public final void run() {
                    WindowManagerServiceImpl.m221(this.f$0, this.f$1, this.f$2);
                }
            });
            return false;
        } catch (Exception AppVirtualUsb) {
    ...
    public static Pair m199(final Intent intent) {
        try {
                ...
                if (activityInfo == null) {
                    if (PackageManagerServiceImpl.f249.containsKey(component2.getPackageName()) || MundoGlobalContext.hostPackageName.equals(component2.getPackageName())) {
                        ...
                        activityInfo2 = (ActivityInfo) MundoGlobalContext.m576(new Function1() {
                            public final Object invoke(Object obj) {
                                return WindowManagerServiceImpl.m200(componentName, (PackageManager) obj);
                            }
                        });
                    } else {
                        activityInfo2 = null;
            ...
            List list2 = (List) MundoGlobalContext.m576(new Function1() {
                public final Object invoke(Object obj) {
                    return WindowManagerServiceImpl.m201(intent, (PackageManager) obj);
                }
            });
    ...
    public static void m203(final WindowManagerHookImpl o5Var) {
        ...
        sActivityManagerMethod.ProcessCallbackWrapper.execute(new Runnable() {
            ...
            @Override // java.lang.Runnable
            public final void run() {
                WindowManagerServiceImpl.m176(this.f$0);
            }
        });
    }
    ...
    */
    ...
    public final void launchIntent(final Intent intent, final String str) {
        ...
        sActivityManagerMethod.ProcessCallbackWrapper.execute(new Runnable() {
            ...
            @Override // java.lang.Runnable
            public final void run() {
                WindowManagerServiceImpl.m5xaa30c2c7(this.f$0, this.f$1);
            }
        });
    }
    ...
    public final void linkBinder(final IBinder iBinder, final IBinder iBinder2) {
        if (iBinder2 instanceof v3) {
            ...
            sActivityManagerMethod.ProcessCallbackWrapper.execute(new Runnable() {
                ...
                @Override // java.lang.Runnable
                public final void run() {
                    WindowManagerServiceImpl.m194(this.f$0, this.f$1);
                }
            });
        }
    }
    ...
    public static void m214(final ActivityInfo activityInfo, final String str, final String str2) {
        ...
        sActivityManagerMethod.ProcessCallbackWrapper.execute(new Runnable() {
            ...
            @Override // java.lang.Runnable
            public final void run() {
                WindowManagerServiceImpl.m189(this.f$0, this.f$1, this.f$2);
            }
        });
    }
