...
public final class AppVirtualGpu extends FunctionReferenceImpl implements Function4 {

    
    public static final AppVirtualGpu f181 = new AppVirtualGpu();

    public AppVirtualGpu() {
