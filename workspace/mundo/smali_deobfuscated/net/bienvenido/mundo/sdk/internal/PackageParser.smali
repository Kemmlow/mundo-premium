.class public final Lnet/bienvenido/mundo/sdk/internal/PackageParser;
...
.method public static 狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰(Landroid/content/Intent;)Landroid/content/pm/ActivityInfo;
    ...
    .line 19
    :try_start_1
    sget-boolean v1, Lnet/bienvenido/mundo/sdk/internal/AppVirtualEnv;->狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰:Z
    ...
    .line 22
    :cond_6
    sget-boolean v1, Lnet/bienvenido/mundo/sdk/internal/AppVirtualEnv;->你不知道你妈张个大嘴劈个小腿下面还流着咸盐水吗弟弟:Z
    ...
    new-instance v2, Lnet/bienvenido/mundo/sdk/internal/r3$1;

    invoke-direct {v2, p0}, Lnet/bienvenido/mundo/sdk/internal/r3$1;-><init>(Landroid/content/Intent;)V
    ...
    .line 36
    new-instance v1, Lnet/bienvenido/mundo/sdk/internal/r3$2;

    invoke-direct {v1, p0}, Lnet/bienvenido/mundo/sdk/internal/r3$2;-><init>(Landroid/content/Intent;)V
    ...
    invoke-static {v1}, Lnet/bienvenido/mundo/sdk/internal/我他妈把你塞进你婊子妈的子宫里再找几根机吧给你搅合搅合让你这个杂种涅槃重生;->狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰(Landroid/content/pm/ApplicationInfo;)Z
    :try_end_31
...
.method public static final 狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰(Ljava/util/List;)V
    ...
    .line 63
    invoke-static {v2}, Lnet/bienvenido/mundo/sdk/internal/xxx烂得过你妈的骚逼么;->狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰(Landroid/content/Intent;)Lkotlin/Triple;
    ...
    .line 65
    sget-boolean v4, Lnet/bienvenido/mundo/sdk/internal/父母们悬挂树木从尸体中养猪让灵车漂浮跳过坟墓螺旋爆炸砂纸打磨棺材冲浪火烧用尸体泡茶将米与骨灰混合在祖坟前唱歌以及埋葬聚会葬礼庆典骨髓汤浇脑花棺材开花;->狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰:Z
