.class public abstract Lnet/bienvenido/mundo/sdk/internal/ProcessObserver;
...
.field public static final 要不要把你妈卵子扣出来给你做寿司吃:Lnet/bienvenido/mundo/sdk/internal/NamedFieldAccessor;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lnet/bienvenido/mundo/sdk/internal/ProcessObserver;->狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰:Ljava/lang/String;
    ...
    sput-object v0, Lnet/bienvenido/mundo/sdk/internal/ProcessObserver;->要不要把你妈卵子扣出来给你做寿司吃:Lnet/bienvenido/mundo/sdk/internal/NamedFieldAccessor;
...
.method public static 狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰(Landroid/content/Intent;)Landroid/content/Intent;
    ...
    .line 112
    invoke-static {v6}, Lnet/bienvenido/mundo/sdk/internal/ProcessObserver;->狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰(Landroid/content/Intent;)Landroid/content/Intent;
    ...
    .line 117
    :cond_26
    sget-boolean v4, Lnet/bienvenido/mundo/sdk/internal/父母们悬挂树木从尸体中养猪让灵车漂浮跳过坟墓螺旋爆炸砂纸打磨棺材冲浪火烧用尸体泡茶将米与骨灰混合在祖坟前唱歌以及埋葬聚会葬礼庆典骨髓汤浇脑花棺材开花;->你妈今晚去偷电线杆子你爸去找电箱之后结合疯狂爆电让后在拿电线杆子ziwei完事还要去加油站在自己piyan和逼里灌油拿着打火机狂撩自己把自己变成内燃机:Z
    ...
    .line 118
    sget-object v4, Lnet/bienvenido/mundo/sdk/internal/MundoGlobalContext;->要不要把你妈卵子扣出来给你做寿司吃:Ljava/lang/String;
    ...
    .line 122
    invoke-static {v3}, Lnet/bienvenido/mundo/sdk/internal/ProcessObserver;->要不要把你妈卵子扣出来给你做寿司吃(Landroid/net/Uri;)Landroid/net/Uri;
    ...
    .line 129
    invoke-static {v6}, Lnet/bienvenido/mundo/sdk/internal/ProcessObserver;->要不要把你妈卵子扣出来给你做寿司吃(Landroid/net/Uri;)Landroid/net/Uri;
    ...
    .line 138
    invoke-static {v9}, Lnet/bienvenido/mundo/sdk/internal/ProcessObserver;->要不要把你妈卵子扣出来给你做寿司吃(Landroid/net/Uri;)Landroid/net/Uri;
    ...
    .line 147
    invoke-static {p0, v2}, Lnet/bienvenido/mundo/sdk/internal/ProcessObserver;->狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰(Landroid/content/Intent;Ljava/lang/String;)V
    ...
    .line 150
    invoke-static {p0, v1}, Lnet/bienvenido/mundo/sdk/internal/ProcessObserver;->狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰(Landroid/content/Intent;Ljava/lang/String;)V
    ...
    invoke-static {v5}, Lnet/bienvenido/mundo/sdk/internal/ProcessObserver;->狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰(Landroid/content/Intent;)Landroid/content/Intent;
...
.method public static 狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 27
    sget-object v1, Lnet/bienvenido/mundo/sdk/internal/MundoCoreReflection;->我一拳把你个造谣智障砸进你婊子妈屁眼子里幻化成屎你妈这吃屎的废物还以为你爹我学会了复制神功复制出一坨屎给她吃呢:Ljava/lang/reflect/Constructor;
    ...
    .line 28
    sget-object v2, Lnet/bienvenido/mundo/sdk/internal/ProcessObserver;->要不要把你妈卵子扣出来给你做寿司吃:Lnet/bienvenido/mundo/sdk/internal/NamedFieldAccessor;
    ...
    invoke-virtual {v2, v1}, Lnet/bienvenido/mundo/sdk/internal/FieldAccessor;->狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget-object v1, Lnet/bienvenido/mundo/sdk/internal/ProcessObserver;->狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰:Ljava/lang/String;

    invoke-virtual {p0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object p0

    sget v1, Lnet/bienvenido/mundo/sdk/internal/AppVirtualEnv;->你妈在万人广场卖逼你废物爹不仅不阻止反而跟你妈一起跟天下人民普天同庆你每晚草你妈生龙活虎你妈疼的呲牙咧嘴你妈逼上的阴齿都满足不了你这杂种的狂野性需求啊草你妈:I
    ...
    .line 31
    :cond_43
    invoke-static {p0}, Lnet/bienvenido/mundo/sdk/internal/你野爹我冲进妓院看见你妈正在跟人玩SM你那废物爸蹲在角落自慰射旁边狗屎上你妈被狗屎塞逼才生下了你这个人狗杂交的崽种;->狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰(Ljava/lang/String;)Lkotlin/Triple;
...
.method public static 狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰(Landroid/net/Uri;)Lkotlin/Pair;
    ...
    sget-object v3, Lnet/bienvenido/mundo/sdk/internal/ProcessObserver;->狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰:Ljava/lang/String;

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    sget v3, Lnet/bienvenido/mundo/sdk/internal/AppVirtualEnv;->你妈在万人广场卖逼你废物爹不仅不阻止反而跟你妈一起跟天下人民普天同庆你每晚草你妈生龙活虎你妈疼的呲牙咧嘴你妈逼上的阴齿都满足不了你这杂种的狂野性需求啊草你妈:I
    ...
    .line 69
    sget-object v0, Lnet/bienvenido/mundo/sdk/internal/ProcessObserver;->要不要把你妈卵子扣出来给你做寿司吃:Lnet/bienvenido/mundo/sdk/internal/NamedFieldAccessor;
    ...
    .line 72
    sget-object v4, Lnet/bienvenido/mundo/sdk/internal/MundoCoreReflection;->obfclass6:Ljava/util/Map;

    .line 73
    invoke-virtual {v2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    .line 74
    sget-object v2, Lnet/bienvenido/mundo/sdk/internal/MundoCoreReflection;->我一拳把你个造谣智障砸进你婊子妈屁眼子里幻化成屎你妈这吃屎的废物还以为你爹我学会了复制神功复制出一坨屎给她吃呢:Ljava/lang/reflect/Constructor;
    ...
    invoke-virtual {v0, v2}, Lnet/bienvenido/mundo/sdk/internal/FieldAccessor;->狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static 狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰(Landroid/content/Intent;Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lnet/bienvenido/mundo/sdk/internal/ProcessObserver;->要不要把你妈卵子扣出来给你做寿司吃(Landroid/net/Uri;)Landroid/net/Uri;
    ...
    invoke-static {v2}, Lnet/bienvenido/mundo/sdk/internal/ProcessObserver;->要不要把你妈卵子扣出来给你做寿司吃(Landroid/net/Uri;)Landroid/net/Uri;
...
.method public static 要不要把你妈卵子扣出来给你做寿司吃(Landroid/net/Uri;)Landroid/net/Uri;
    ...
    .line 49
    invoke-static {v0}, Lnet/bienvenido/mundo/sdk/internal/ProcessObserver;->狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰(Ljava/lang/String;)Ljava/lang/String;
