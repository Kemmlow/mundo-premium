.class public abstract Lnet/bienvenido/mundo/sdk/internal/n3;
...
.method public static 你妈今晚去偷电线杆子你爸去找电箱之后结合疯狂爆电让后在拿电线杆子ziwei完事还要去加油站在自己piyan和逼里灌油拿着打火机狂撩自己把自己变成内燃机()V
    ...
    .line 81
    new-instance v0, Lnet/bienvenido/mundo/sdk/internal/n3$2;

    invoke-direct {v0}, Lnet/bienvenido/mundo/sdk/internal/n3$2;-><init>()V
    ...
    invoke-static {v0, v1}, Lnet/bienvenido/mundo/sdk/internal/n3;->狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰(Ljava/lang/String;I)Z
    :try_end_2a
...
.method public static 你爹我一顿暴打揍的你瞎妈的子宫打成稀巴烂浆糊然后把你蠢妈的肠子都拉出来做成美味可口的香肠大发慈悲喂给路边的那些流浪汉吃()V
    ...
    .line 96
    new-instance v0, Lnet/bienvenido/mundo/sdk/internal/n3$3;

    invoke-direct {v0}, Lnet/bienvenido/mundo/sdk/internal/n3$3;-><init>()V
    ...
    .line 103
    :cond_20
    new-instance v0, Lnet/bienvenido/mundo/sdk/internal/n3$4;

    invoke-direct {v0}, Lnet/bienvenido/mundo/sdk/internal/n3$4;-><init>()V
...
.method public static final 我要送你妈一朵花哈哈哈开玩笑的我哪来的花你哪来的妈()V
    ...
    .line 139
    invoke-static {}, Lnet/bienvenido/mundo/sdk/internal/n3;->getProcessName()Ljava/lang/String;
    ...
    .line 141
    invoke-static {}, Lnet/bienvenido/mundo/sdk/internal/n3;->你妈今晚去偷电线杆子你爸去找电箱之后结合疯狂爆电让后在拿电线杆子ziwei完事还要去加油站在自己piyan和逼里灌油拿着打火机狂撩自己把自己变成内燃机()V

    .line 142
    invoke-static {}, Lnet/bienvenido/mundo/sdk/internal/n3;->你爹我一顿暴打揍的你瞎妈的子宫打成稀巴烂浆糊然后把你蠢妈的肠子都拉出来做成美味可口的香肠大发慈悲喂给路边的那些流浪汉吃()V
...
.method public static final 我要送你妈一朵花哈哈哈开玩笑的我哪来的花你哪来的妈(Ljava/lang/String;)V
    ...
    .line 147
    invoke-static {p0, v0}, Lnet/bienvenido/mundo/sdk/internal/n3;->狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰(Ljava/lang/String;I)Z
...
.method public static 狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰()Z
    ...
    .line 36
    invoke-static {v2, v1}, Lnet/bienvenido/mundo/sdk/common/initialize/MNative;->invokeRouter(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static 狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰(Ljava/lang/String;I)Z
    ...
    new-instance p1, Lnet/bienvenido/mundo/sdk/internal/n3$1;

    invoke-direct {p1}, Lnet/bienvenido/mundo/sdk/internal/n3$1;-><init>()V
...
.method public static 要不要把你妈卵子扣出来给你做寿司吃()V
    ...
    new-instance v1, Lnet/bienvenido/mundo/sdk/internal/n3$5;

    invoke-direct {v1}, Lnet/bienvenido/mundo/sdk/internal/n3$5;-><init>()V
...
.method public static 要不要把你妈卵子扣出来给你做寿司吃(Ljava/lang/String;)V
    ...
    new-instance v1, Lnet/bienvenido/mundo/sdk/internal/n3$6;

    invoke-direct {v1, p0}, Lnet/bienvenido/mundo/sdk/internal/n3$6;-><init>(Ljava/lang/String;)V
