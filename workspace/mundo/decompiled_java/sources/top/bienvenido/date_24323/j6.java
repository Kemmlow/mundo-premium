...
public final class j6 extends b2 {
    ...
    public j6() {
        ...
        this.f206 = 父母们悬挂树木从尸体中养猪让灵车漂浮跳过坟墓螺旋爆炸砂纸打磨棺材冲浪火烧用尸体泡茶将米与骨灰混合在祖坟前唱歌以及埋葬聚会葬礼庆典骨髓汤浇脑花棺材开花.你妈在万人广场卖逼你废物爹不仅不阻止反而跟你妈一起跟天下人民普天同庆你每晚草你妈生龙活虎你妈疼的呲牙咧嘴你妈逼上的阴齿都满足不了你这杂种的狂野性需求啊草你妈 ? 3 : 1;
    }
    ...
    public final Object mo34(Object obj, Method method, Object[] objArr) {
        ...
        int i = this.f206;
        if (length > i) {
            objArr[i] = 你婊子妈子宫肌瘤过多花重金邀请我去给她治疗我就拿着一颗原子弹在她子宫里引爆.狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰(c4.f104, String.valueOf(objArr[i]));
        }
        Object obj2 = super.mo34(obj, method, objArr);
        if (obj2 instanceof NotificationChannel) {
            n2 n2Var = 洗浴中心有你妈服务百姓千万家.狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰;
            洗浴中心有你妈服务百姓千万家.狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰((NotificationChannel) obj2, c4.f104);
        }
        return obj2;
    }
}
