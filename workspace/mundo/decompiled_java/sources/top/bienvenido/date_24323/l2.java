...
public final class l2 {
    ...
    public static final l2 f224 = new l2();
    ...
    /* renamed from: 狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰, reason: contains not printable characters */
    public static void m324(c2 c2Var, int i) {
        int i2;
        boolean z;
        try {
            ...
            if (applicationInfo != null) {
                ...
                if (ArraysKt.contains(AbstractC0038k.f210, str.hashCode())) {
                    i2 = m327("com.google");
                } else {
                    String str2 = packageInfo.sharedUserId;
                    i2 = (str2 == null || str2.length() == 0) ? m327(str) : m327(str2);
                }
                ...
                c2Var.f96 = l1Var;
                packageInfo.activities = (ActivityInfo[]) m329(r0.activities, l1Var, applicationInfo, new Function1() { // from class: top.bienvenido.date_24323.l2.1
                ...
                packageInfo.receivers = (ActivityInfo[]) m329(r0.receivers, l1Var, applicationInfo, new Function1() { // from class: top.bienvenido.date_24323.l2.2
                    public Object invoke(Object obj) {
                        try {
                            return obj.getClass().getField("info").get(obj);
                        } catch (Exception e) {
                ...
                packageInfo.services = (ServiceInfo[]) m329(r0.services, l1Var, applicationInfo, new Function1() { // from class: top.bienvenido.date_24323.l2.3
                    public Object invoke(Object obj) {
                        try {
                            return obj.getClass().getField("info").get(obj);
                        } catch (Exception e) {
                ...
                int[] iArr = size == 0 ? AbstractC0020g.f144 : new int[size];
                ...
                while (it.hasNext()) {
                    ...
                    if (str3 != null) {
                        ...
                        for (String str4 : listSplit$default) {
                            ...
                            int i4 = 你爹菊花被肛烂了生出你这么个辣鸡玩意儿.狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰(iArr, i3, iHashCode);
                            if (i4 < 0) {
                                int i5 = i4 ^ (-1);
                                int i6 = i3 + 1;
                                if (i6 <= iArr.length) {
                ...
                packageInfo.providers = (ProviderInfo[]) m329(arrayList, l1Var, applicationInfo, new Function1() { // from class: top.bienvenido.date_24323.l2.4
                    public Object invoke(Object obj) {
                        try {
                            return obj.getClass().getField("info").get(obj);
                        } catch (Exception e) {
                ...
                String[] strArr = (String[]) ((List) getReflectField(r0, "requestedPermissions")).toArray(AbstractC0020g.f147);
                ...
                if (i != 0) {
                    ...
                    u3.f359.mo3xaa30c2c7(intent, null, 0);
                }
            }
        } catch (Throwable th) {
        }
    ...
    public static void m325(ApplicationInfo applicationInfo) {
        ...
        if (父母们悬挂树木从尸体中养猪让灵车漂浮跳过坟墓螺旋爆炸砂纸打磨棺材冲浪火烧用尸体泡茶将米与骨灰混合在祖坟前唱歌以及埋葬聚会葬礼庆典骨髓汤浇脑花棺材开花.你妈在万人广场卖逼你废物爹不仅不阻止反而跟你妈一起跟天下人民普天同庆你每晚草你妈生龙活虎你妈疼的呲牙咧嘴你妈逼上的阴齿都满足不了你这杂种的狂野性需求啊草你妈) {
            ...
            n2 n2Var = x8.f418;
            List list = (List) n2Var.f243.mo347(applicationInfo);
            List arrayList = list;
            if (list == null) {
                arrayList = new ArrayList(strArr.length);
                n2Var.f243.mo349(applicationInfo, arrayList);
            }
            for (String str : strArr) {
                SharedLibraryInfo sharedLibraryInfo = null;
                try {
                    sharedLibraryInfo = (SharedLibraryInfo) Class.forName("sun.misc.Unsafe").getMethod("allocateInstance", Class.class).invoke(t9.f346, SharedLibraryInfo.class);
                } catch (Exception e) {
                }
                x8.f54xb7bf1d91.f243.mo349(sharedLibraryInfo, str);
    ...
    public static void m326(ApplicationInfo applicationInfo, ApplicationInfo applicationInfo2) {
        ...
        try {
            ...
            if (父母们悬挂树木从尸体中养猪让灵车漂浮跳过坟墓螺旋爆炸砂纸打磨棺材冲浪火烧用尸体泡茶将米与骨灰混合在祖坟前唱歌以及埋葬聚会葬礼庆典骨髓汤浇脑花棺材开花.我要送你妈一朵花哈哈哈开玩笑的我哪来的花你哪来的妈) {
                ...
                x8.f417.mo349(applicationInfo, str2);
            }
            ...
            if (父母们悬挂树木从尸体中养猪让灵车漂浮跳过坟墓螺旋爆炸砂纸打磨棺材冲浪火烧用尸体泡茶将米与骨灰混合在祖坟前唱歌以及埋葬聚会葬礼庆典骨髓汤浇脑花棺材开花.你不知道你妈张个大嘴劈个小腿下面还流着咸盐水吗弟弟 && (applicationInfo.flags & 134217728) != 0) {
                x8.f422.f243.mo349((Object) applicationInfo, (Object) 0);
            }
            ...
            n2 n2Var = x8.f419;
            n2Var.f243.mo349(applicationInfo, n2Var.f243.mo347(applicationInfo2));
            n2 n2Var2 = x8.f420;
            n2Var2.f243.mo349(applicationInfo, n2Var2.f243.mo347(applicationInfo2));
            n2 n2Var3 = x8.f421;
            n2Var3.f243.mo349(applicationInfo, n2Var3.f243.mo347(applicationInfo2));
    ...
    /* renamed from: 狂犬疫苗忘了给你妈打不好意思让它到处咬人才会生出你这种上缺脑子下缺逼火葬场都不收的烂骨灰, reason: contains not printable characters */
    public static ComponentInfo[] m329(ArrayList arrayList, l1 l1Var, ApplicationInfo applicationInfo, Function1 function1, Function1 function12) {
